...
function ShopByBodyTypeSection() {
  return (
    <section className="bg-white border-b border-gray-100 py-12 overflow-hidden">
      <div className="text-center mb-8 px-4">
        <p className="text-[10px] tracking-[0.28em] uppercase font-bold text-[#C8102E] mb-2">Browse By Body Type</p>
...
// Render body type cards after ShopByBodyTypeSection wrapper
// (continued where the component builds the grid earlier)
