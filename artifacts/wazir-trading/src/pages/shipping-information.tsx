...
import { Mail, ChevronRight, ArrowRight, Ship, Info } from 'lucide-react';
...
export default function ShippingInformationPage() {
  useMeta({
    ...
    canonical: 'https://www.wazirtradingllc.com/shipping-information',
  });
