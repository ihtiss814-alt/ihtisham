...
export default function Navbar() {
  ...
  // Never leave a touch menu open after switching to a desktop viewport, and
  // make Escape behave like the close button for keyboard and mobile users.
  useEffect(() => {
  ...
  return (
    <>
              ...
              <Link href="/" className="flex-shrink-0 group" data-testid="link-logo">
                <picture>
                  ...
                  <img
                    ...
                    className="h-[68px] md:h-[72px] w-auto transition-opacity duration-200 group-hover:opacity-85"
      ...
      <div
        className={`mobile-nav-backdrop fixed inset-0 z-40 bg-black/40 backdrop-blur-sm transition-opacity duration-200 ${
      ...
      <div
        ...
        className={`mobile-nav-drawer fixed top-0 right-0 bottom-0 z-50 w-[min(320px,88vw)] bg-white flex flex-col transition-transform duration-300 ease-out ${
