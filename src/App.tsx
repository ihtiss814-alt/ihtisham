...
const AutoPartsPage            = React.lazy(() => import('@/pages/auto-parts'));
...
function Router() {
  return (
    // Keep the shared shell visible while a secondary route chunk loads.
    // The homepage is eager-loaded so a fresh visit never shows an interstitial.
